...
const Card = (props) => {
  ...
  return (
    <div
      onClick={toggleCard}
      className={`group relative w-80 h-[520px] bg-cover bg-center rounded-xl overflow-hidden shadow-lg shadow-sky-800/50 transition-all duration-500 
    ...
    >
      ...
      ></div>
      <div
        className={`absolute right-0 w-full bg-gradient-to-b from-black/80 to-transparent text-white text-center py-3 transition-transform duration-500
      ...
      <div
        className={`arc-overlay absolute bottom-0 w-full text-white p-5 flex flex-col justify-end gap-2 transition-opacity duration-700
