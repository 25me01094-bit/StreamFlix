                ...
                {allGenres.map((genre) => {
                    ...
                    return (
                        <div key={genre} className="mb-10 relative group">
                            ...
                            <div ref={scrollRef} className="flex gap-4 overflow-x-auto px-2 pb-4 scroll-smooth snap-x snap-mandatory scrollbar-hide" >
                                {movies
                                    .filter((movie) => movie.genre.includes(genre))
                                    .map((movie) => (
                                        <div key={movie.id} className="min-w-[200px] md:min-w-[240px] snap-start group" >
                                            <div className="relative">
                                                <img src={movie.poster} alt={movie.title} className="w-full h-[320px] object-cover rounded-lg" />
