...
//                 <p className="text-red-400 text-xl text-center px-4">
//                     🚫 Oops! That search seems inappropriate. <br />
//                     Try something like <span className="text-sky-400">"feel-good comedy"</span> or <span className="text-sky-400">"space adventure"</span> 🎬
//                 </p>
//             </div>
//         );
//     }
